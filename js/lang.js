...
(function () {
  ...
  const AR = {
    ...
    'credit.label': 'بِالدِّين (الزبون)',
    'credit.ph': 'اتركه فارغًا لبيع نقدي',
    'sell.go': 'تسجيل البيع',
    ...
    'settings.title': 'الإعدادات', 'settings.sub': 'المحل، اللغة، خيارات اليوم',
  ...
  const EN = {
    ...
    'credit.label': 'On credit (customer)',
    'credit.ph': 'leave empty for cash sale',
    'sell.go': 'Record sale',
    ...
    'settings.title': 'Settings', 'settings.sub': 'Shop, language, day options',
