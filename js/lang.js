...
(function () {
  ...
  const AR = {
    ...
    'report.checkPastDay': 'العدّ يُسجّل على يوم اليوم — عدّ صندوق اليوم أو ارجع ليوم اليوم',
    ...
    'auth.mergeAsk': 'في السحابة نسخة مختلفة من دكانك.\n\nإذا أخذتَها، ما عندك على هذا الجهاز يُستبدل (نسخة محفوظة). إذا رفضتَ، يبقى دكانك كما هو.',
    'auth.mergeKept': 'بقي دكانك كما هو — النسخة الأخرى موجودة على السحابة',
    'auth.accountOpen': 'سجّل دكانك على السحابة',
    'auth.accountManage': 'حسابك',
    'auth.pass2': 'أعد كتابة كلمة السر',
    'auth.syncNever': 'السحابة مطفأة — الدكان على هذا الجهاز فقط',
    'auth.syncPending': 'لم تُرفع البيانات بعد',
    'auth.syncAt': 'آخر مزامنة: {t}',
    'auth.syncFailed': 'تعذّرت المزامنة — بياناتك محفوظة على هذا الجهاز',
    'auth.syncLocal': 'بقيت بيانات هذا الجهاز — لم نأخذ نسخة السحابة',
    'auth.expired': 'انتهت الجلسة — سجّل الدخول من جديد',
    'auth.err.offline': 'لا يمكن الوصول للخادم — تحقق من الإنترنت',
    'auth.err.server': 'الخادم مشكلتو — بياناتك محفوظة، أعد المحاولة لاحقاً',
    'auth.err.passMismatch': 'كلمتا السر غير متطابقتين',
  ...
  const EN = {
    ...
    'report.checkPastDay': 'Box counts are filed under today — go back to today to count',
    ...
    'auth.mergeAsk': 'The cloud has a different copy of your shop.\n\nIf you take it, what is on this device is replaced (a copy is kept). If you refuse, your shop stays exactly as it is.',
    'auth.mergeKept': 'Your shop stayed as it is — the other copy is on the cloud',
    'auth.accountOpen': 'Back up this shop to the cloud',
    'auth.accountManage': 'Your account',
    'auth.pass2': 'Type the password again',
    'auth.syncNever': 'Cloud is off — this shop lives on this device only',
    'auth.syncPending': 'Nothing uploaded yet',
    'auth.syncAt': 'Last synced: {t}',
    'auth.syncFailed': 'Sync failed — your data is safe on this device',
    'auth.syncLocal': 'This device was kept — the cloud copy was not taken',
    'auth.expired': 'Session expired — sign in again',
    'auth.err.offline': 'Cannot reach the server — check your connection',
    'auth.err.server': 'The server is broken — your data is safe, try again later',
    'auth.err.passMismatch': 'The two passwords do not match',
